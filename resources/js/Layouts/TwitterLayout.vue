    ...
    <div class="fixed w-full">
        <div class="max-w-[1400px] flex mx-auto">
            ...
            <div class="
                ...
                relative
                ">
                <div class="bg-black bg-opacity-50 backgrop-blur-md z-10 absolute w-full">
            ...
            <div class="lg:block hidden lg-w-4/12 w-1/12 h-screen border-l border-gray-800 pl-4">
